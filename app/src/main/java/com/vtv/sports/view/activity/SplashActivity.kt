...
//        }
        ...
        object : CountDownTimer(Constant.DELAY_TO_MAIN, 25) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                binding.progressLoading.progress =
                        ((Constant.DELAY_TO_MAIN - millisUntilFinished) * 100 / Constant.DELAY_TO_MAIN).toInt()
